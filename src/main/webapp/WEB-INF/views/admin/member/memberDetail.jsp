			...
			<table>
				<tbody>
					<tr class="dot_line">
						...
						<td>
							<input name="member_id" type="text" size="20"
								value="${member_info.member_id }" disabled
							/>
						</td>
						<td>
					...
					<tr class="dot_line">
						...
						<td>
							<input name="member_name" type="text" size="20"
					...
					<tr class="dot_line">
						...
						<td>
							...
							<input type="text" size=4 name="tel2"
								value="${member_info.tel2 }"
							>
							-
							<input type="text" size=4 name="tel3"
								value="${member_info.tel3 }"
							>
						</td>
						<td>
							<input type="button" value="수정하기"
						...
						<td>
							...
							<p>
								...
								<input type="text" id="jibunAddress" name="jibunAddress"
									size="50" value="${member_info.jibunAddress }"
								>
								<br>
								<br> 나머지 주소:
