...
<body>
	...
	<form action="${contextPath}/member/addMember.do" method="post"
				...
				<tbody>
					<tr class="dot_line">
						...
						<td><input type="text" name="_member_id" id="_member_id"
							...
							value="중복체크" onClick="fn_overlapped()" /> <input type="hidden"
							name="chk_member_id" id="chk_member_id" value="n" /></td>
					</tr>
					<tr class="dot_line">
		...
		<div class="clear">
			...
			<table align=center>
				<tr>
					<td><input type="button" id="btnSubmit" onClick="fn_submit()"
						value="회원 가입"> <input type="reset" value="다시입력"></td>
				</tr>
			</table>
		</div>
	</form>
